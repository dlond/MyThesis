...
For each $\alpha \in \Delta$ (the simple roots)
	...
	\item[5.] Calculate $H^1(SL_2(k), V_\alpha)_{\omega_r}$.
	\item[6.] Calculate $H^1(SL_2(k), V_\alpha)_{\omega_r}/C_L(\omega_r)$ and use Theorem \ref{main_thm} to get information about conjugacy classes in $\mathrm{Hom}(SL_2(k), P_\alpha)$.
	\end{itemize}
