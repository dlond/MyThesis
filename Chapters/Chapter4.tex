...
\begin{proof}  
  ...
  Since $h$ is onto so is $\overline{h}$. Now take $[\alpha_\sigma] = [\alpha_\tau]$ for some $\alpha_\sigma, \alpha_\tau \in Z^1(\Gamma, \rho_L, V)$. Then there exists a $v \in V$ such that
  \begin{displaymath}
...
Suppose $\overline{\sigma} = \overline{\tau}$. Then there is a $v \in V$ such that $\sigma = v \cdot \tau \in Hom(\Gamma, P)_{\rho_L}$, and a $v' \in V$ such that $zv = v' z$. Therefore
\begin{eqnarray*}
  z \cdot \overline{\sigma} &=& \overline{z \cdot \sigma} \\
  &=& \overline{zv \cdot \tau} \\
...
Hence the $Z(L)$-action on $H^1(\Gamma, \rho_L, V)$ is well-defined.
...
\begin{proof}
  ...
  Denote by $\pi_Z$ the canonical projection from $Hom(\Gamma, P)_{\rho_L}/V \rightarrow \left( Hom(\Gamma, P)_{\rho_L} \right)/Z(L)$ and $\tilde{\sigma}$ the element of $Hom(\Gamma, P)_{\rho_L}/VZ(L)$ with representative $\sigma \in Hom(\Gamma, P)_{\rho_L}$. Then
  \begin{eqnarray*}
    && \pi_Z(\overline{\sigma}) = \pi_Z(\overline{\tau}) \\
    &\Longleftrightarrow& \textrm{there exists a } z \in Z(L) \textrm{ such that } \overline{\sigma} = z \cdot \overline{\tau} \\
    &\Longleftrightarrow& \textrm{there exists a } z \in Z(L) \textrm{ such that } \overline{\sigma} = \overline{z \cdot \tau} \\
    &\Longleftrightarrow& \textrm{there exists a } v \in V \textrm{ and a } z \in Z(L) \textrm{ such that } \overline{\sigma} = z \cdot \overline{\tau} \\
