...
%This leads us to define $\mathcal{H}: Hom(\Gamma, Q_i)_{\sigma_i^j} \rightarrow H^1(\Gamma, \sigma_i^j, V_i) / Z(M_i)^\circ$ by the composition
%\begin{displaymath}
%  Hom(\Gamma, Q_i)_{\sigma_i^j} \rightarrow Hom(\Gamma, Q_i)_{\sigma_i^j} / V_i Z(M_i)^\circ \rightarrow H^1(\Gamma, \sigma_i^j, V_i) / Z(M_i)^\circ.
%\end{displaymath}
%That is $\mathcal{H}(\rho) = \tilde{h}(\tilde{\rho})$ for all $\rho \in Hom(\Gamma, Q_i)_{\sigma_i^j}$. Sinc
