...
The next Lemma is standard [reference] but we give our own proof here.
...
We call the (\ref{theNonabOneCocycleCondition}) the \emph{1-cocycle condition}.
