...
Fix a finite set $\{Q_i\}$ of representatives of the finitely many $G$-conjugacy classes of parabolic subgroups of $G$ [Reference Humphreys].
...
Choose a Levi subgroup $L<Q$, so that $Q = R_u(Q)\rtimes L$. Define $\rho_0:\Gamma\rightarrow L$ by composing $\rho'$ with the projection $Q\rightarrow L$:
\begin{displaymath}
	\xymatrix{
