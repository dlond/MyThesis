...
\begin{lemma} Define the relation $\sim$ on $Z^1(K, V)$ by
	\begin{align}
		\sigma_1 \sim \sigma_2 \Leftrightarrow \exists v \in V,\forall x \in K, \sigma_1 = v\sigma_2(x)(x \cdot v^{-1}).
		\label{eqn:h_equiv}
	\end{align}
Then $\sim$ is an equivalence relation.
\end{lemma}
\begin{proof}
The relation is symmetric, since $\sigma(x) = 1\sigma(x)(1 \cdot x^{-1})$ for all $\sigma\in Z^1(K, V)$ and all $x \in K$. It is reflexive since
\begin{align*}
...
\end{align*}
where $\pi$ is the canonical projection $\pi:SL_2 \rightarrow SL_2/B$ (\cite[TODO]{humphreys1975linear}). Hence $\widehat{\sigma}(xB) = \sigma(x)$ for all $x \in SL_2(k)$.
