...
If the above ask Conjecture is true, it would be worthwhile to see whether it can be extended to parabolic subgroups $P_I$, $I\subset \Delta$ of higher rank. This would be useful for further 1-cohomology calculations following the method we employ in the next Chapter.
