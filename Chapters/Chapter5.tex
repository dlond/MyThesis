...
\end{itemize}
Then there exist $\mu_\delta\in k$ such that for all $a\in k^*$ and all $b\in k$
\begin{align*}
...
\end{proof}
\begin{remark}\label{sigmaneg}
We have $\sigma\left(\begin{matrix}-a & -b\\0 & -a^{-1}\end{matrix}\right) = \sigma\left(\begin{matrix}a & b\\0 & a^{-1}\end{matrix}\right)$. For suppose $p>2$, then
\begin{align*}
	...
	&=\sigma\left(\begin{matrix}a & b\\0 & a^{-1}\end{matrix}\right).
\end{align*}
Furthermore, by replacing $\alpha$ with $-\alpha$, the above Lemma determines $\sigma\left(\begin{matrix}a & 0\\c & a^{1}\end{matrix}\right)$.
\end{remark}
