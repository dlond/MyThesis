...
By Lemma \ref{trivial_on_t}, there exists $\sigma \in Z^1(SL_2(k), V_\alpha)_{\omega_r}$ such that $\psi(\tau) = \psi(\sigma)$ and $\sigma\left(y\right) = 1$ for all $y\in T_2(k)$. Hence we may proceed with $\sigma$.
