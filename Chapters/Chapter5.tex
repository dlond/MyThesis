...
Let $x$ be an element of the kernel of the map $H^1(i):H^1(B,V)\rightarrow H^1(U,V)$ and let $\sigma$ be a representative in $Z^1(B,V)$ for $x$. Since $Z^1(i)(\sigma)$ represents the class containing the trivial 1-cocycle we may assume that $\sigma(u) = 1$ for all $u$ in $U$. There exists a $v$ in $V$ such that $\sigma(t) = \chi(t)$ for all $t$ in $T$. Define
\begin{eqnarray*}
...
Since for any $u\in U$ $\sigma(u) = 1$ and for any $t\in T$ there is a $u'$ such that $ut = tu'$
\begin{eqnarray*}
	\sigma(ut) &=& \sigma(tu')\\
